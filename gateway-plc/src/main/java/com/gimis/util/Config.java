...
public class Config {
	...
	public Config(){
		 ...
		 try {
			...
			setShowDebugDetail(Integer.parseInt(prop.getProperty("showDebugDetail").trim()));
	...
	public int getShowDebugDetail() {
		return showDebugDetail;
	}

	public void setShowDebugDetail(int showDebugDetail) {
		this.showDebugDetail = showDebugDetail;
	}
